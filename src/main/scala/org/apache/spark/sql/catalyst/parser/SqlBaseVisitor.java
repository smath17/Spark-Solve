...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code solveQuerySpecification}
	 * labeled alternative in {@link SqlBaseParser#querySpecification}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSolveQuerySpecification(SqlBaseParser.SolveQuerySpecificationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#selectFromHelper}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelectFromHelper(SqlBaseParser.SelectFromHelperContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#solveClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSolveClause(SqlBaseParser.SolveClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#objectiveClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectiveClause(SqlBaseParser.ObjectiveClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#subjecttoClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSubjecttoClause(SqlBaseParser.SubjecttoClauseContext ctx);
	/**
