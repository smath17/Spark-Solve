...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code solveQuerySpecification}
	 * labeled alternative in {@link SqlBaseParser#querySpecification}.
	 * @param ctx the parse tree
	 */
	void enterSolveQuerySpecification(SqlBaseParser.SolveQuerySpecificationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code solveQuerySpecification}
	 * labeled alternative in {@link SqlBaseParser#querySpecification}.
	 * @param ctx the parse tree
	 */
	void exitSolveQuerySpecification(SqlBaseParser.SolveQuerySpecificationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#selectFromHelper}.
	 * @param ctx the parse tree
	 */
	void enterSelectFromHelper(SqlBaseParser.SelectFromHelperContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#selectFromHelper}.
	 * @param ctx the parse tree
	 */
	void exitSelectFromHelper(SqlBaseParser.SelectFromHelperContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#solveClause}.
	 * @param ctx the parse tree
	 */
	void enterSolveClause(SqlBaseParser.SolveClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#solveClause}.
	 * @param ctx the parse tree
	 */
	void exitSolveClause(SqlBaseParser.SolveClauseContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#objectiveClause}.
	 * @param ctx the parse tree
	 */
	void enterObjectiveClause(SqlBaseParser.ObjectiveClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#objectiveClause}.
	 * @param ctx the parse tree
	 */
	void exitObjectiveClause(SqlBaseParser.ObjectiveClauseContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#subjecttoClause}.
	 * @param ctx the parse tree
	 */
	void enterSubjecttoClause(SqlBaseParser.SubjecttoClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#subjecttoClause}.
	 * @param ctx the parse tree
	 */
	void exitSubjecttoClause(SqlBaseParser.SubjecttoClauseContext ctx);
	/**
